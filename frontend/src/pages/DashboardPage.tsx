...
import { Plus, Trash2, Eye, Globe, Lock, Calendar, Sparkles } from 'lucide-react';
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-12">
        <div className="flex flex-col sm:flex-row justify-between items-start sm:items-center gap-4 mb-12">
          <div>
            ...
            <p className="text-gray-400">Create and manage your physics simulations</p>
          </div>
          <Link 
            to="/simulation/new" 
            className="group px-6 py-3 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-500 hover:to-primary-600 rounded-xl font-semibold transition-all duration-300 shadow-lg shadow-primary-500/30 hover:shadow-primary-500/50 hover:scale-105"
          >
        ...
        {isLoading ? (
          <div className="text-center py-20">
            ...
            <p className="text-gray-400 mt-4">Loading your simulations...</p>
          </div>
        ) : simulations.length === 0 ? (
          <div className="text-center py-20">
            <div className="inline-flex p-6 bg-gradient-to-br from-primary-500/10 to-purple-500/10 rounded-full mb-6 border border-primary-500/20">
              <Sparkles className="text-primary-400" size={48} />
            </div>
            <h3 className="text-2xl font-semibold mb-2">No Simulations Yet</h3>
            <p className="text-gray-400 mb-8 max-w-md mx-auto">
              Start your physics journey by creating your first simulation
            </p>
            <Link 
              to="/simulation/new" 
              className="inline-block px-8 py-4 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-500 hover:to-primary-600 rounded-xl font-semibold transition-all duration-300 shadow-lg shadow-primary-500/30"
            >
                ...
                >
                  ...
                  <div className={`h-32 bg-gradient-to-br ${colorGradient} relative overflow-hidden`}>
                    ...
                    <div className="absolute top-4 right-4">
                      {sim.isPublic ? (
                        <div className="flex items-center space-x-1 px-3 py-1 bg-green-500/20 backdrop-blur-sm rounded-full border border-green-500/30">
                          <Globe size={14} className="text-green-400" />
                          <span className="text-green-300 text-xs font-medium">Public</span>
                        </div>
                      ) : (
                        <div className="flex items-center space-x-1 px-3 py-1 bg-gray-500/20 backdrop-blur-sm rounded-full border border-gray-500/30">
                          <Lock size={14} className="text-gray-400" />
                          <span className="text-gray-300 text-xs font-medium">Private</span>
                        </div>
                      )}
                    </div>
                    <div className="absolute bottom-4 left-4">
                      <div className="text-white/90 text-sm font-medium px-3 py-1 bg-black/30 backdrop-blur-sm rounded-full border border-white/20">
                  ...
                  <div className="p-6">
                    ...
                    <div className="flex items-center space-x-2 text-sm text-gray-500 mb-4 pb-4 border-b border-gray-700/50">
                      <Calendar size={14} />
                    ...
                    <div className="flex space-x-2">
                      <Link
                        ...
                        className="flex-1 px-4 py-3 bg-gradient-to-r from-primary-600 to-primary-700 hover:from-primary-500 hover:to-primary-600 rounded-xl font-semibold text-center transition-all duration-300 shadow-lg shadow-primary-500/20 hover:shadow-primary-500/40"
                      >
                      ...
                      <button
                        ...
                        className="px-4 py-3 bg-red-600/20 hover:bg-red-600/30 border border-red-600/30 hover:border-red-600/50 rounded-xl transition-all duration-300"
